...
namespace TaskMasterSovellus.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TaskId,StateId,TaskName,TaskDescription,TaskPoints,TaskPriority")] Tasks tasks)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskId,StateId,TaskName,TaskDescription,TaskPoints,TaskPriority")] Tasks tasks)
        {
            if (ModelState.IsValid)
            {
